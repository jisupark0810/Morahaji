...
public class WordAddListAction implements Action {
	...
	public ActionForward execute(HttpServletRequest request, HttpServletResponse response) throws Exception {
		...
		request.setAttribute("userProfile", userDAO.getProfiles(Integer.parseInt(session.getAttribute("userKey").toString())));
